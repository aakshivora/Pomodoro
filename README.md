...
It is a time management technique transferred into a Web Application to unable users to manage break and work time symmerically and be as much productive as one can be.
